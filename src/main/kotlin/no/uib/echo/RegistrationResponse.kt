...
fun resToJson(
    ...
    when (res) {
        ...
        RegistrationResponse.DegreeMismatchBachelor, RegistrationResponse.DegreeMismatchMaster, RegistrationResponse.DegreeMismatchKogni, RegistrationResponse.DegreeMismatchArmninf ->
            return RegistrationResponseJson(
                res,
                "Studieretning og årstrinn stemmer ikke overens.",
                defaultDesc,
                regDate
            )
